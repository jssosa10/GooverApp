...
def upload_recurso():
	...
	for file in request.files:
		...
		cursor.execute('insert into recursos values(null,%s,"Documento",%s)' % (str(base_file_name),str(resp.url)))
